...
<div class="grid__wrapper">
  ...
  <div class="grid__item">
    <article class="archive__item" style="border: 1px solid #eee; padding: 20px; border-radius: 10px;">
      ...
      <p class="archive__item-excerpt" style="font-size: 0.9em; margin-top: 10px;">Modelo predictivo bajo estándares del MIT para clasificar la experiencia del usuario. Utiliza aprendizaje supervisado (XGBoost) para predecir niveles de satisfacción.</p>
    </article>
  </div>
